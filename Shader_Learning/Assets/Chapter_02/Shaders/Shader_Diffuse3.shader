  Shader "Custom/Shader_Chapter03/Diffuse3"        //shader路径
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType"="Opaque" }  //Opaque : 表示不透明的渲染
        LOD 200
        ...
        //pragma 编译器指令
        // 下面定义的surf表面处理函数  
        //Standard:unity的标准光照模型  
        //funllforwardshadows:完整的前向阴影

        // Use shader model 3.0 target, to get nicer looking lighting
        #pragma target 3.0  //使用3.0版本的shader
